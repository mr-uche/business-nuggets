    ...
    <div className="min-h-screen bg-[#050505] text-[#EDEAE3]">
      ...
      <main className="mx-auto max-w-[1200px] px-10 py-12">
        ...
        <div className="flex items-start justify-between">
          ...
          <div>
            <h1 className="font-serif text-[27px] text-white">
          ...
          <button className="flex items-center gap-2 rounded-md border border-red-500/20 px-3 py-2 text-[9px] text-red-400 transition hover:bg-red-500/5">
            <Trash2 size={11} />
            Clear History
          </button>
        ...
        {/* ================= CONTENT ================= */}
        <div className="mt-8 grid grid-cols-[1fr_320px] gap-7">

          {/* ================= LISTENING HISTORY ================= */}
          <section>

            <div className="flex items-center gap-2">
              <h2 className="text-[15px] font-medium uppercase tracking-wide text-[#C9A227]">
                Listening History
              </h2>
            ...
            <div className="mt-4 space-y-3">
              ...
              {listeningHistory.map((item) => (
                <div
                  key={item.title}
                  className="rounded-md border border-white/10 bg-[#0d0d0d] px-4 py-4"
                >
                  ...
                  {/* Title */}
                  <h3 className="mt-3 font-serif text-[18px] text-white">
                    {item.title}
                  </h3>
                  ...
                  <div className="mt-5 flex items-center justify-between gap-3">
                    ...
                    <div className="h-[3px] w-[270px] rounded-full bg-white/10">
                      <div
                    ...
                    <span className="w-[28px] text-[10px] text-white/40">
                      {item.progress}%
                    </span>

                    {/* Action */}
                    <button className="flex items-center gap-1.5 rounded-md border border-white/10 px-3 py-1.5 text-[10px] text-white/60 transition hover:border-white/20 hover:text-white">
                      <RotateCcw size={10} />
