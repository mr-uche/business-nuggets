...
export default function PlaylistDetailPage() {
  return (
    <div className="min-h-screen bg-blacktext-[#EDEAE3]">
      <Navbar />

      <main className="mx-auto max-w-[1200px] px-10 py-12">

        {/* ================= PLAYLIST HEADER ================= */}
        <section className="rounded-lg border border-white/10 bg-[#101010] p-6">

          <div className="flex items-center gap-5">

            {/* Playlist image */}
            <div className="h-[120px] w-[150px] shrink-0 overflow-hidden rounded-md bg-[#17130d]">
              <img
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex items-center justify-between gap-6 text-[12px] text-white/50">
        ...
        <section className="mt-5 space-y-2">
          ...
          {playlistItems.map((item) => (
            <div
              key={item.number}
              className="group flex h-[66px] items-center rounded-md border border-white/10 bg-[#0d0d0d] px-3 transition hover:border-white/20"
            >
