  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#EDEAE3]">
      ...
      <main className="mx-auto max-w-[1200px] px-10 py-14">
        ...
        {/* ================= TOP SECTION ================= */}
        <section className="grid grid-cols-[350px_1fr] gap-14">
          ...
          <div className="min-w-0 pt-1">
            ...
            <div className="flex min-h-[68px] items-center justify-between rounded-md border border-[#C9A227]/60 bg-[#0c0c0b] px-6 py-4">
